      ...
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-3 text-sm">
          <a
            ...
            rel="noreferrer"
          >
            <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 18 18" fill="currentColor">
          ...
          <a href="mailto:hello@walawow.fun" className="btn-outline px-4 py-2 inline-flex items-center gap-2">
            <svg aria-hidden="true" className="h-4 w-4" viewBox="0 0 18 18" fill="currentColor">
